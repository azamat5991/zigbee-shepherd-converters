...
const devices = [
    ...
    */
	...
	//Orvibo
	{
		...
		vendor: 'ORVIBO', 
		description: 'Door/Window Sensor ', 
		supports: 'door switch', 
		fromZigbee: [fz.ignore_genIdentify,fz.ignore_genIdentify_change,fz.generic_battery_change,fz.generic_battery_remaining,fz.ias_contact_dev_change, fz.ias_contact_status_change], // We w$
		toZigbee: [], 
		configure: (ieeeAddr, shepherd, coordinator, callback) => {
				const device = shepherd.find(ieeeAddr, 1);
				const actions = [
